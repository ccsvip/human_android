...
import ai.guiji.duix.test.databinding.ActivityLocalCallBinding
...
class LocalCallActivity : BaseActivity() {
    ...
    private lateinit var binding: ActivityLocalCallBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        keepScreenOn()
        binding = ActivityLocalCallBinding.inflate(layoutInflater)
